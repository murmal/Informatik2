...
public class GameOfLifeApplication extends Application {
	 ...
	 */
	private GameOfLifeInterface logic = new GameOfLifeLogic();
    ...
    public void start(Stage primaryStage) {
		...
		logic.setStartGeneration(currentStartGeneration);
		golCanvas = new GameOfLifeCanvas((GameOfLifeLogic) logic, 600, 600);
		...
		final PauseTransition pt = new PauseTransition(Duration.millis(200));
		pt.setCycleCount(1);
